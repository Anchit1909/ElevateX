  ...
  <div className="w-8/12  ml-40 border-r-2 pr-12 border-gray-900 mt-24">
    ...
    <div className="mt-6 text-gray-600 text-lg">
      <h1>
        ...
        Stable Diffusion APIs, Auth, CMS, admin dashboard, Stripe and landing
        page. Quickly launch an AI business MVP, saving time and money on early
        development, focus capital on defining use case.
      </h1>
      <h1>
        Launched in SaaS, Artificial Intelligence, Tech by AI Starter | An AI
        "Biz-in-a-Box"
      </h1>
    </div>
    ...
    <div className="mt-20 bg-blue-50">
      ...
      <h1 className="text-gray-600 pl-10 text-lg">
        <i>
          "Thanks for checking out our launch - if you have any APIs you think
          would be useful for us to aggregate as part of our modular package, do
          let us know! Our roadmap is pretty exciting and include a lot more
          collabs and partnerships - do stay tuned! :)"
        </i>
      </h1>
    </div>
  </div>
