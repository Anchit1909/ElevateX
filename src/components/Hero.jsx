    ...
    <section>
      <div className="flex flex-col max-w-screen-xl items-center justify-center mx-auto md:flex-row ">
        <div className="my-36 flex flex-col flex-1">
          <motion.h1
            className="px-3 lg-px-0 font-semibold text-6xl text-gray-900 font-poppins max-w-lg md:max-w-xl relative z-10 "
            initial={{ opacity: 0, y: -50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1 }}
          >
            Unleash your Startups potential
          </motion.h1>
          ...
          <motion.p
            className="px-3 lg-px-0 text-gray-600 mt-4 text-lg max-w-md font-inter z-10"
          ...
          <motion.div
            className="px-3 lg-px-0 mt-4 space-x-2 font-inter flex flex-row items-center z-10"
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 1 }}
          >
